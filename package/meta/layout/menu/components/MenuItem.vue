...
<template>
  <el-menu-item :route="routeChildren" :index="routeChildren.name" @click.capture="handleLink">
    <div v-if="routeChildren.meta.icon">
      <i class="iconfont" :class="routeChildren.meta.icon" />
